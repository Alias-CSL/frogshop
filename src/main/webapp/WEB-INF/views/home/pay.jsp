...
<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<div class="concent">
				...
				<div class="paycont">
					<div class="address">
						<h3>确认收货地址 </h3>
						<div class="control">
							<div class="tc-btn createAddr theme-login am-btn am-btn-danger" data-am-modal="{target: '#new-addrss-edit'}">使用新地址</div>
						</div>
						<div class="clear"></div>
									...
									<c:forEach items="${addresses }" var="address" varStatus="vs">
										<div class="per-border"></div>
											...
											<c:if test="${address.status == 2 }">
												...
												<input type="hidden" value="${address.id }" name="id" id="addressId-input"/>
												<div class="address-left">
													<div class="user DefaultAddr">
													<p class="new-tit new-p-re">
														<span class="buy-address-detail">   
				                   						<span class="buy-user new-txt ">${address.contacterName} </span>
													...
													<p class="new-mu_l2cw">
														...
														<span class="dist">${address.districts }</span>
												...
												<div class="new-addr-btn ">
													...
													<c:if test="${address.status == 1 }">
														<a href="#" class="hidden save-default-btn" class="set-default" >设为默认</a>
													</c:if>
													<span class="new-addr-bar hidden">|</span>
													<a href="#" class="edit-address"  data-am-modal="{target: '#my-confirm'}"><i class="am-icon-edit"></i>编辑</a>
					...
					<div class="logistics">
						...
						<ul class="op_express_delivery_hot">
							<li data-value="yuantong" class="OP_LOG_BTN  "><i class="c-gap-right" style="background-position:0px -468px"></i><span data-value="圆通快递"></span>圆通</li>
							<li data-value="shentong" class="OP_LOG_BTN  "><i class="c-gap-right" style="background-position:0px -1008px"></i><span data-value="申通快递"></span>申通</li>
							<li data-value="yunda" class="OP_LOG_BTN  "><i class="c-gap-right" style="background-position:0px -576px"></i><span data-value="韵达快递"></span>韵达</li>
							<li data-value="zhongtong" class="OP_LOG_BTN op_express_delivery_hot_last "><i class="c-gap-right" style="background-position:0px -324px"></i><span data-value="中通快递"></span>中通</li>
							<li data-value="shunfeng" class="OP_LOG_BTN  op_express_delivery_hot_bottom"><i class="c-gap-right" style="background-position:0px -180px"></i><span data-value="顺丰快递"></span>顺丰</li>
						</ul>
					</div>
					<div class="clear"></div>
 ...
 --%>
								...
								<div id="J_Bundle_s_1911116345_1_0" class="bundle  bundle-last">
									<div class="bundle-main">
										<ul class="item-content clearfix">
											<div class="pay-phone">
												<li class="td td-item">
													<input type="hidden" value="${sku.id }" id="skuId"/>
													<div class="item-pic">
														<a href="#" class="J_MakePoint">
															<img src="${sku.picture }" class="itempic J_ItemImg" width="80" height="80"/></a>
													</div>
													<div class="item-info">
														<div class="item-basic-info">
															<a href="<%=basePath%>good/introduction/${sku.goodId}" target="_blank" title="${goodName }" class="item-title J_MakePoint" data-point="tbcart.8.11">${goodName }</a>
														</div>
													</div>
												</li>
												<li class="td td-info">
												...
												<div class="amount-wrapper ">
													<div class="item-amount ">
														...
														<div class="sl">
															...
															<input class="text_box" name="" type="text" value="${goodNum }" style="width:30px;" />
			...
			<div class="clear"></div>
			<div class="am-modal am-modal-confirm" tabindex="-1" id="new-addrss-edit">
			  <div class="am-modal-dialog">
			    ...
			    <div class="am-modal-bd am-u-md-12">
			     <form method="post" id="form-create" class="am-form am-form-horizontal" action="#">
						<input type="hidden" value="${sessionScope.userId }" name="userId"/>
						<div class="am-form-group">
							<label for="username" class="am-form-label">收货人</label>
							<div class="am-form-content">
								<input type="text" id="username1" name="contacterName" placeholder="收货人"/>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-form-content">
								<input id="user-phone1" placeholder="手机号必填" type="text" name="phone"/>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-form-content edit-address">
								<select style="width: 33%;float: left;" name="province" class="new-buy-province">
									
								</select>
								<select style="width: 33%;float: left;" name="city" class="new-buy-city">
									
								</select>
								<select style="width: 33%;float: left;" name="districts"	class="new-buy-dist">
						...
						<div class="am-form-group" >
							...
							<div class="am-form-content detial-address-div">
								<textarea class="detial-address" rows="3" name="address" id="user-intro1" placeholder="输入详细地址"></textarea>
			...
			<div class="am-modal am-modal-confirm" tabindex="-1" id="my-confirm">
			  <div class="am-modal-dialog">
			    <div class="am-modal-hd">
					<div class="am-cf am-padding">
					<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">修改地址</strong> / <small>Change address</small></div>
					</div>
					<hr/>
			    </div>
			    <div class="am-modal-bd am-u-md-12">
			     <form method="post" id="form-change" class="am-form am-form-horizontal" action="#" >
						<input type="hidden" value="${sessionScope.userId }" name="userId" />
						<input type="hidden" name="id" id="address-id"/>
						<div class="am-form-group">
							<label for="user-name" class="am-form-label">收货人</label>
							<div class="am-form-content">
								<input type="text" id="username" placeholder="收货人" name="contacterName"/>
							</div>
						</div>
						...
						<div class="am-form-group">
							<label for="user-phone" class="am-form-label ">所在地</label>
							<div class="am-form-content edit-address">
								<select style="width: 33%;float: left;" name="province" class="buy-province">
									
								</select>
								<select style="width: 33%;float: left;" name="city" class="buy-city">
									
								</select>
								<select style="width: 33%;float: left;" name="districts"	class="buy-dist">
						...
						<div class="am-form-group" >
							<label for="user-intro" class="am-form-label">详细地址</label>
							<div class="am-form-content detial-address-div">
								<textarea class="detial-address" rows="3" name="address" id="user-intro" placeholder="输入详细地址"></textarea>
								<small style="float: left;">100字以内写出你的详细地址...</small>
							</div>
						</div>
		...
		<script type="text/javascript" src="<%=basePath %>/js/addressMessage.js"></script>
		<script type="text/javascript" src="<%=basePath %>/js/address-handle.js"></script>
