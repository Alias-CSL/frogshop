     ...
     <c:choose>
     	<c:when test="${not empty newOrder }">
	       ...
	       <div class="user-info">
	        ...
	        <button type="button" class="am-btn am-btn-danger"  data-am-modal="{target: '#my-alert'}">立即支付</button>  
	        <a  href="<%=basePath%>index.html"  type="button" class="am-btn am-btn-danger">继续购物</a>
       </c:when>  
     </c:choose>                      
     </ul>
     <div class="option">
       <span class="info">您可以</span>
        <a href="<%=basePath%>order.html" class="J_MakePoint">查看<span>订单详情</span></a>
     </div>
    </div>
  </div>
</div>
