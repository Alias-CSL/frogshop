				...
				<div class="am-u-sm-12 am-u-md-12">
					<div class="theme-popover">
						...
						<ul class="select">
							...
							<div class="clear"></div>
							<div id="category-div" title="${category.id }">
								<c:choose>
									<c:when test="${not empty category.attributeNames }">
										<c:forEach items="${category.attributeNames}" varStatus="vs"
											var="attributeName">
											<li class="select-list">
												<dl id="select-${vs.count }" title="select${vs.count }"
													class="select-dl">
													<dt class="am-badge am-round"
														title="${attributeName.name }">${attributeName.name }</dt>
													<div class="dd-conent">
														<dd class="select-all selected">
															<a href="#" disabled="disabled">全部</a>
														</dd>
														<c:forEach items="${attributeName.attributeValues }"
															varStatus="vs" var="attributeValue">
															<dd title='${attributeValue.name}'>
																<a href="#">${attributeValue.name}</a>
															</dd>
														</c:forEach>
													</div>
												</dl>
					...
					<div class="search-side">
						...
						<li>
							<div class="i-pic check">
								<img src="<%=basePath %>images/cp.jpg" />
						...
						<li>
							<div class="i-pic check">
								<img src="<%=basePath %>images/cp2.jpg" />
				...
				<div class="footer-bd">
					<p>
						<a href="#">关于恒望</a> <a href="#">合作伙伴</a> <a href="#">联系我们</a> <a
							href="#">网站地图</a> <a href="<%=basePath%>backgoundLogin.html">后台登陆</a>
