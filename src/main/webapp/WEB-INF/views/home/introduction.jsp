...
<script type="text/javascript"
	src="<%=basePath %>js/jquery.imagezoom.min.js"></script>
<script type="text/javascript"
	src="<%=basePath %>js/jquery.flexslider.js"></script>
						...
						<c:when test="${sessionScope.loginFlag}">
							<div class="am-dropdown" data-am-dropdown>
								<button class="am-btn am-round  am-dropdown-toggle"
									data-am-dropdown-toggle style="background:none;font-size:15px;">
				...
				<ul class="slides">
					<c:choose>
						<c:when test="${not empty good.descPictures }">
							<c:forEach items="${good.descPictures}" var="descPicture"
								varStatus="vs">
								<li><img src="${descPicture.descPicture}" title="pic"
		...
		<div class="item-inform">
			<div class="clearfixLeft" id="clearcontent">
				...
				<div class="box">
					...
					<div class="tb-booth tb-pic tb-s310">
						<a href="#"><img src="${good.descPictures[0].descPicture}"
							alt="细节展示放大镜特效" rel="${good.descPictures[0].descPicture}"
							class="jqzoom" /></a>
					</div>
								...
								<c:forEach items="${good.descPictures }" var="descPicture"
									...
									<li class="tb-selected">
										<div class="tb-pic tb-s40">
											<a href="#"><img src="${descPicture.descPicture}"
												mid="${descPicture.descPicture}"
												big="${descPicture.descPicture}"></a>
										</div>
									</li>
								</c:forEach>
							</c:when>
				...
				<div style="margin-top: 10px;" id="div-collection">
					<a id="addToCollection" data-am-modal="{target: '#my-alert'}"><i
						class="am-icon-star" style="color: #FF8743;"></i>收藏宝贝</a>
				</div>
				<div class="clear"></div>
			</div>
			...
			<div class="clearfixRight">
				...
				<div class="tb-detail-hd">
					<h1 id="h1-goodName">${good.goodName }</h1>
				...
				<div class="tb-detail-list">
					...
					<div class="tb-detail-price">
						<li class="price iteminfo_price">
							<dt>促销价</dt>
							<dd>
								<em>¥</em><b class="sys_item_price">${good.skus[0].price }</b>
							</dd>
						</li>
						<li class="price iteminfo_mktprice">
							<dt>原价</dt>
							<dd>
								<em>¥</em><b class="sys_item_mktprice">${good.originalPrice }</b>
							</dd>
						</li>
						<div class="clear"></div>
					</div>
					...
					<ul class="tm-ind-panel">
						...
						<li class="tm-ind-item tm-ind-sumCount canClick">
							<div class="tm-indcon">
								<span class="tm-label">累计销量</span><span class="tm-count">${good.totalSales }</span>
							</div>
						</li>
						<li class="tm-ind-item tm-ind-reviewCount canClick tm-line3">
							<div class="tm-indcon">
								<span class="tm-label">累计评价</span><span class="tm-count"
									id="total-comment-span"></span>
							</div>
						</li>
					</ul>
					<div class="clear"></div>
												...
												<c:when test="${not empty attributes}">
													<c:forEach items="${attributes }" var="attribute"
														...
														<div class="theme-options">
															...
															<ul>
																<c:forEach items="${attribute.attributes }" var="value"
																	varStatus="vs">
											...
											<div class="theme-options1">
												...
												<dd>
													<input id="min" class="am-btn am-btn-default" name=""
														...
														type="button" value="+" /> <span class="tb-hidden">库存<span
														class="stock" id="stock">${good.stocks }</span>件
													</span>
												</dd>
				...
				<div class="pay">
					...
					<li>
						<div class="clearfix tb-btn tb-btn-buy theme-login">
							<a id="LikBuy" title="点此按钮到下一步确认购买信息" onclick="buy_good()"
								href="javascript:void(0)">立即购买</a>
						</div>
					</li>
					<li>
						<div class="clearfix tb-btn tb-btn-basket theme-login">
							<a id="LikBasket" title="加入购物车" onclick="add_cart()"
								href="javascript:void(0)"><i></i>加入购物车</a>
						</div>
					</li>
				</div>
				...
				<div class="mc">
					<ul>
						...
						<li class="first">
							<div class="p-img">
								<a href="#"> <img class=""
									src="<%=basePath %>images/browse1.jpg">
								</a>
							</div>
							<div class="p-name">
			...
			<div class="introduceMain">
				<div class="am-tabs" data-am-tabs>
					<ul class="am-avg-sm-3 am-tabs-nav am-nav am-nav-tabs">
						...
						<li><a href="#"> <span class="index-needs-dt-txt"
								id="total-comment">全部评价</span></a></li>
								...
								<ul id="J_AttrUL">
									<c:choose>
										<c:when test="${not empty productAttributes}">
											<c:forEach items="${productAttributes }"
												var="productAttribute" varStatus="vs">
								...
								<div class="twlistNews">
									<c:choose>
										<c:when test="${not empty good.detailPictures }">
											<c:forEach items="${ good.detailPictures}"
												var="detailPicture" varStatus="vs">
						...
						<div class="am-tab-panel am-fade">
							...
							<div class="actor-new">
								...
								<dl>
									<dt>买家印象</dt>
									<dd class="p-bfc">
										<q class="comm-tags"><span>样式很好</span><em>(15)</em></q> <q
											class="comm-tags"><span>质量很好饱满</span><em>(14)</em></q> <q
											class="comm-tags"><span>很舒服</span><em>(13)</em></q> <q
											class="comm-tags"><span>物流快</span><em>(12)</em></q> <q
											class="comm-tags"><span>色彩很好</span><em>(11)</em></q> <q
											class="comm-tags"><span>实惠</span><em>(10)</em></q>
									</dd>
								</dl>
							</div>
							<div class="clear"></div>
								...
								<ul class=" tb-taglist am-avg-sm-4">
									<li class="tb-taglist-li tb-taglist-li-current">
										<div class="comment-info">
											<span>全部评价</span> <span class="tb-tbcr-num">${evaluatePageInfo.total }</span>
										</div>
									</li>

									<li class="tb-taglist-li tb-taglist-li-1">
										<div class="comment-info">
											<span>追评</span> <span class="tb-tbcr-num">(10)</span>
										</div>
									</li>
	...
	<div class="am-modal am-modal-alert" tabindex="-1" id="my-alert">
		<div class="am-modal-dialog">
			...
			<div class="am-modal-bd">
				...
				<img src="${good.descPictures[0].descPicture }" width="80"
					height="80" />${good.goodName }
			</div>
			<div class="am-modal-footer">
				<span class="am-modal-btn" id="collectGood">确定</span> <span
