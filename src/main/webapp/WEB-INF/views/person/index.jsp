...
<link href="<%=basePath %>css/personal.css" rel="stylesheet"
	type="text/css">
<link href="<%=basePath %>css/systyle.css" rel="stylesheet"
	type="text/css">
							...
							<div class="m-userproperty">
								...
								<p class="m-bonus">
									<a href="bonus.html"> <i><img
											src="<%=basePath %>images/bonus.png" /></i> <span class="m-title">红包</span>
										<em class="m-num">2</em>
									</a>
								</p>
								<p class="m-coupon">
									<a href="coupon.html"> <i><img
											src="<%=basePath %>images/coupon.png" /></i> <span
										class="m-title">优惠券</span> <em class="m-num">2</em>
									</a>
								</p>
								<p class="m-bill">
									<a href="bill.html"> <i><img
											src="<%=basePath %>images/wallet.png" /></i> <span
										class="m-title">钱包</span> <em class="m-num">2</em>
									</a>
								</p>
								<p class="m-big">
									<a href="#"> <i><img
											src="<%=basePath %>images/day-to.png" /></i> <span
										class="m-title">签到有礼</span>
									</a>
								</p>
								<p class="m-big">
									<a href="#"> <i><img src="<%=basePath %>images/72h.png" /></i>
						...
						<div class="m-order">
							...
							<ul>
								<li><a href="order.html"><i><img
											src="<%=basePath %>images/pay.png" /></i><span>待付款</span></a></li>
								<li><a href="order.html"><i><img
											src="<%=basePath %>images/send.png" /></i><span>待发货<em
											class="m-num">1</em></span></a></li>
								<li><a href="order.html"><i><img
											src="<%=basePath %>images/receive.png" /></i><span>待收货</span></a></li>
								<li><a href="order.html"><i><img
											src="<%=basePath %>images/comment.png" /></i><span>待评价<em
											class="m-num">3</em></span></a></li>
								<li><a href="change.html"><i><img
											src="<%=basePath %>images/refund.png" /></i><span>退换货</span></a></li>
							</ul>
						</div>
						<!--九宫格-->
							...
							<div class="s-content">
								<ul class="lg-list">
									...
									<li class="lg-item">
										<div class="item-info">
											<a href="#"> <img
												src="<%=basePath %>images/65.jpg_120x120xz.jpg"
									...
									<li class="lg-item">
										<div class="item-info">
											<a href="#"> <img
												src="<%=basePath %>images/88.jpg_120x120xz.jpg"
							...
							<div class="s-content">
									...
									<div class="s-item">
										...
										<div class="s-pic">
											<a href="#" class="s-pic-link"> <img
												src="<%=basePath %>images/0-item_pic.jpg_220x220.jpg"
								...
								<div class="s-item-wrap">
									<div class="s-item">
										...
										<div class="s-pic">
											<a href="#" class="s-pic-link"> <img
												src="<%=basePath %>images/1-item_pic.jpg_220x220.jpg"
								...
								<div class="s-item-wrap">
									<div class="s-item">
										...
										<div class="s-pic">
											<a href="#" class="s-pic-link"> <img
												src="<%=basePath %>images/-0-saturn_solar.jpg_220x220.jpg"
						...
						<div class="new-goods-info">
							<a class="shop-info" href="#" target="_blank">
								<div class="face-img-panel">
									<img src="<%=basePath %>images/imgsearch1.jpg" alt="">
