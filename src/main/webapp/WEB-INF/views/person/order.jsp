...
<ul class="message-l">
		...
		<div class="col-main">
			<div class="main-wrap">
				...
				<div class="user-order">
					...
					<div class="am-tabs am-tabs-d2 am-margin" id="doc-my-tabs"
						data-am-tabs>
	...
	<div class="am-modal am-modal-confirm" tabindex="-1" id="my-confirm">
		<div class="am-modal-dialog">
			<div class="am-modal-hd">
				<div class="am-cf am-padding">
					<div class="am-fl am-cf">
						<strong class="am-text-danger am-text-lg">商品评价</strong> / <small>Comment
							evaluation</small>
					</div>
				</div>
				<hr />
				...
				<form method="post" id="form-comment"
					...
					<div class="am-form-group">
						...
						<div style="float:left;">
							<input type="radio" name="grade" value="1"
								style="margin-left:80px;" /><img alt=""
								src="<%=basePath %>images/goodreview.png"
								style="width:30px;height:35px;" /> <input type="radio"
								name="grade" value="2" style="margin-left:20px;" /><img alt=""
								src="<%=basePath %>images/assessment.png"
								style="width:30px;height:35px;" /> <input type="radio"
								name="grade" value="3" style="margin-left:20px;" /><img alt=""
								src="<%=basePath %>images/badreview.png"
					...
					<div class="am-form-group">
						...
						<div class="am-form-content detial-address-div">
							<textarea class="detial-address" rows="3" name="content"
	...
	<div class="am-modal am-modal-confirm" tabindex="-1"
		...
		<div class="am-modal-dialog">
			...
			<div class="am-modal-bd">你，确定要取消该订单吗？</div>
			<div class="am-modal-footer">
				<span class="am-modal-btn close" data-am-modal-cancel>取消</span> <span
					class="am-modal-btn" id="cancalOrder-span" data-am-modal-confirm>确定</span>
			</div>
		</div>
	</div>
