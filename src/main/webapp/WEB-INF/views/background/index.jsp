	...
	<div class="layui-layout layui-layout-admin" id="layui_layout">
			...
			<div class="layui-main">
				...
				<ul class="layui-nav larry-header-item">
					<li class="layui-nav-item">
						账户名：${sessionScope.loginEntity.userName}</li>
					...
					<li class="layui-nav-item"><a
						href="<%=basePath %>logoutBackground"> <i
			...
			<div class="layui-side-scroll" id="larry-nav-side" lay-filter="side">
				...
				<ul class="layui-nav layui-nav-tree">
					...
					<li class="layui-nav-item"><a href="javascript:;"> <i
							class="iconfont icon-jiaoseguanli"></i> <span>个人中心</span> <em
						...
						<dl class="layui-nav-child">
							...
							<dd>
								<a href="javascript:;" data-url="myloginfo.html"> <i
					...
					<li class="layui-nav-item"><a href="javascript:;"> <i
						...
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" data-url="<%=basePath %>table.html">
									<i class="iconfont icon-yonghu1" data-icon='icon-yonghu1'></i>
									<span>商品上下架</span>
								</a>
							</dd>
							<dd>
								<a href="javascript:;" data-url="<%=basePath %>addGood.html">
									<i class="iconfont icon-jiaoseguanli4"
									data-icon='icon-jiaoseguanli4'></i> <span>商品添加</span>
								</a>
							</dd>
							<dd>
								<a href="javascript:;" data-url="<%=basePath %>myloginfo.html">
					...
					<!-- 内容管理 -->
					<li class="layui-nav-item"><a href="javascript:;"> <i
							class="iconfont icon-wenzhang1"></i> <span>订单管理</span> <em
							class="layui-nav-more"></em>
					</a>
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" data-url="404.html"> <i
									class="iconfont icon-lanmuguanli" data-icon='icon-lanmuguanli'></i>
									<span>退换货管理</span>
								</a>
							</dd>
							<dd>
								<a href="javascript:;" data-url="<%=basePath %>shipments.html"> <i class="iconfont icon-wenzhang2"
									data-icon='icon-wenzhang2'></i> <span>发货管理</span>
								</a>
							</dd>
							<dd>
					...
					<li class="layui-nav-item"><a href="javascript:;"> <i
						...
						<dl class="layui-nav-child">
							...
							<dd>
								<a href="javascript:;" data-url="tab.html"> <i
		...
		<div class="layui-footer layui-larry-foot" id="larry-footer">
			<div class="layui-mian">
				<p class="p-admin">
					<span>2017 &copy;</span> 广州青蛙科技股份有限公司,版权所有
				</p>
			</div>
		</div>
	</div>
