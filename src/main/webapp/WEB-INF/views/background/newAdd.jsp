...
<body class="childrenBody">
	<form class="layui-form">
		...
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-block">
					<input name="tuijian" class="tuijian" title="推荐" type="checkbox">
					<div class="layui-unselect layui-form-checkbox" lay-skin="">
						<span>推荐</span><i class="layui-icon"></i>
					</div>
					<input name="shenhe" class="newsStatus" title="审核" type="checkbox">
					<div class="layui-unselect layui-form-checkbox" lay-skin="">
						<span>审核</span><i class="layui-icon"></i>
					</div>
					<input name="show" class="isShow" title="展示" type="checkbox">
					<div class="layui-unselect layui-form-checkbox" lay-skin="">
						<span>展示</span><i class="layui-icon"></i>
					</div>
				</div>
			</div>
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					...
					<div class="layui-unselect layui-form-select">
						<div class="layui-select-title">
							<input placeholder="开放浏览" value="开放浏览" readonly=""
								class="layui-input layui-unselect" type="text"><i
								class="layui-edge"></i>
						</div>
						<dl class="layui-anim layui-anim-upbit">
							<dd lay-value="0" class="layui-this">开放浏览</dd>
							<dd lay-value="1" class="">会员浏览</dd>
						</dl>
					</div>
				</div>
			</div>
			...
			<div class="layui-input-block">
				...
				<div class="layui-layedit">
					<div class="layui-unselect layui-layedit-tool">
						<i class="layui-icon layedit-tool-b" title="加粗" lay-command="Bold"
							layedit-event="b""=""></i><i class="layui-icon layedit-tool-i"
							title="斜体" lay-command="italic" layedit-event="i""=""></i><i
							class="layui-icon layedit-tool-u" title="下划线"
							lay-command="underline" layedit-event="u""=""></i><i
							class="layui-icon layedit-tool-d" title="删除线"
							lay-command="strikeThrough" layedit-event="d""=""></i><span
							class="layedit-tool-mid"></span><i
							...
							class="layedit-tool-mid"></span><i
							class="layui-icon layedit-tool-link" title="插入链接"
							layedit-event="link""=""></i><i
							class="layui-icon layedit-tool-unlink layui-disabled"
							title="清除链接" lay-command="unlink" layedit-event="unlink""=""></i><i
							class="layui-icon layedit-tool-face" title="表情"
							layedit-event="face""=""></i><i
							class="layui-icon layedit-tool-image" title="图片"
							layedit-event="image"><input name="file" type="file"></i>
					</div>
					<div class="layui-layedit-iframe">
						<iframe id="LAY_layedit_1" name="LAY_layedit_1"
	...
	<script type="text/javascript" src="<%=basePath %>js/newsadd.js"></script>
