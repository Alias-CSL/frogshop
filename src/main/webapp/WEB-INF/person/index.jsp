...
<html>
	...
	<body>
						...
						<div class="wrap-list">
							<div class="m-user">
								...
								<div class="m-userproperty">
									...
									<p class="m-big">
										<a href="#">
											<i><img src="<%=basePath %>images/day-to.png"/></i>
											<span class="m-title">签到有礼</span>
										</a>
									</p>
									<p class="m-big">
										<a href="#">
											<i><img src="<%=basePath %>images/72h.png"/></i>
							...
							<div class="m-order">
								...
								<ul>
									<li><a href="order.html"><i><img src="<%=basePath %>images/pay.png"/></i><span>待付款</span></a></li>
									<li><a href="order.html"><i><img src="<%=basePath %>images/send.png"/></i><span>待发货<em class="m-num">1</em></span></a></li>
									<li><a href="order.html"><i><img src="<%=basePath %>images/receive.png"/></i><span>待收货</span></a></li>
									<li><a href="order.html"><i><img src="<%=basePath %>images/comment.png"/></i><span>待评价<em class="m-num">3</em></span></a></li>
									<li><a href="change.html"><i><img src="<%=basePath %>images/refund.png"/></i><span>退换货</span></a></li>
								</ul>
							</div>
							<!--九宫格-->
		...
		<!--引导 -->
		<div class="navCir">
			<li><a href="<%=basePath %>home/home.html"><i class="am-icon-home "></i>首页</a></li>
			<li><a href="<%=basePath %>home/sort.html"><i class="am-icon-list"></i>分类</a></li>
			<li><a href="<%=basePath %>home/shopcart.html"><i class="am-icon-shopping-basket"></i>购物车</a></li>	
