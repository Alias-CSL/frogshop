...
public class LoginTypeMatch {
	...
	public static void main(String[] args) {
		System.out.println(LoginTypeMatch.loginType("zhangsan"));
		System.out.println(LoginTypeMatch.loginType("13257617382"));
		System.out.println(LoginTypeMatch.loginType("833965726@qq.com"));
